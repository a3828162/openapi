...
// List of ApplyAction
const (
	ApplyAction_BUFFER  ApplyAction = "BUFFER"
	ApplyAction_REPORT  ApplyAction = "REPORT"
	ApplyAction_FORWARD ApplyAction = "FORWARD"
	ApplyAction_DISCARD ApplyAction = "DISCARD"
)
