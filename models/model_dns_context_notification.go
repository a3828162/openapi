...
// Data within DNS Context Notify
type DnsContextNotification struct {
	EventreportList []DnsContextEventReport `json:"eventreportList,omitempty" yaml:"eventreportList" bson:"eventreportList,omitempty"`
}
