...
type BaseDnsPatternCreateData struct {
	...
	BaseDnsMdtList map[string]BaselineDnsMdt `json:"baseDnsMdtList,omitempty" yaml:"baseDnsMdtList" bson:"baseDnsMdtList,omitempty"`
	// map of Baseline DNS action information Template where a valid JSON string serves as key
	BaseDnsAitList map[string]BaselineDnsAit `json:"baseDnsAitList,omitempty" yaml:"baseDnsAitList" bson:"baseDnsAitList,omitempty"`
